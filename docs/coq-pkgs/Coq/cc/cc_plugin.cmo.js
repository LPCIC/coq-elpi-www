...
al=104,aC=".",bV=108,bM="  [",bJ=3901498,bK=" : ",bU=-431191102,aY=-912009552,U=250,$="Init",N=246,aD="congruence",bP="[",bT="l",bI="A",bS="with",aF="]",bR=128,bH=915186972,bO=888453194,_="Logic",bN=" and ",bG=-318868643,aE=107,bQ="Heq",aW="f_equal",aB=15500,aX=1e3,bL="n",x=e8.jsoo_runtime,r=x.caml_check_bound,aj=x.caml_int_compare,ay=x.caml_make_vect,d=x.caml_new_string,T=x.caml_obj_tag,ak=x.caml_register_global,s=x.caml_wrap_exception;function
...
h=x.caml_get_global_data(),av=d("cc_plugin"),o=h.Constr,n=h.Names,aa=h.Hashset,a1=h.Sorts,j=h.Util,t=h.Not_found,a8=h.Term,e=h.EConstr,P=h.Typing,g=h.Int,v=h.Queue,c=h.Pp,aO=h.Control,D=h.CErrors,bd=h.Environ,bb=h.Assert_failure,p=h.Tacmach,aH=h.Feedback,aZ=h.Printer,ad=h.Hashtbl,af=h.Pervasives,M=h.Termops,S=h.CamlinternalLazy,q=h.Tacticals,k=h.Proofview,E=h.Tactics,by=h.Evarsolve,bB=h.DAst,aT=h.Coqlib,bw=h.Equality,bv=h.Context,br=h.CClosure,bs=h.Reductionops,aw=h.Stdarg,ax=h.Genarg,bE=h.Ltac_plugin,aG=[0,0],dr=d("Out of depth ... "),dq=d("Out of instances ... "),ds=d("First run was incomplete, completing ... "),dp=d("Executing ... "),dn=d("Running E-matching algorithm ... "),dm=d("paf_of_patt: pattern is trivial"),dj=d("wrong incomplete class."),dc=d(" ... "),dd=d(" = "),de=d("Checking if "),db=d("Yes"),df=d("No"),c_=d(aC),c$=d("Processing mark for term "),c7=d("weird error in injection subterms merge."),c8=[0,d("add_pacs")],c5=d(aC),c6=d("Updating term "),c2=d(aC),c3=d(bN),c4=d("Merging "),cY=d(aC),cZ=d(bN),c0=d("Linking "),cX=[0,d("plugins/cc/ccalgo.ml"),641,2],cQ=d(aF),cR=d(" <> "),cS=d(bK),cT=d(bM),cU=d("Adding new disequality, depth="),cL=d(aF),cM=d(" == "),cN=d(bK),cO=d(bM),cP=d("Adding new equality, depth="),cK=d("discarding redundant (dis)equality"),cG=d(aF),cH=d(bP),cD=d(aF),cE=d(":="),cF=d(bP),cC=d("incomplete matching."),cs=d("not a node."),ct=[0,d("subterms")],cj=d("not a constructor."),ck=[0,d("get_constructor")],cf=d("not a representative."),cg=[0,d("get_representative")],b7=d("signature already entered."),b8=[0,d("enter")],bY=[0,d("Congruence"),[0,d("Verbose"),0]],bZ=d("Congruence Verbose"),cp=d("Ccalgo.Discriminable"),cv=d(bI),cx=d(bI),dg=d("_eps_"),dt=d("invalid cc transitivity."),du=d("not enough args."),dv=[0,d("nth_arg")],dw=[0,1,20],dx=d("equal_proof "),dy=[0,1,20],dz=d("edge_proof "),dA=[0,1,20],dB=d("constr_proof "),dD=d(","),dC=d("}"),dE=d("{"),dF=[0,1,20],dG=d("path_proof "),dH=[0,1,20],dI=d("congr_proof "),dJ=[0,1,20],dK=d("ind_proof "),d2=[0,0],d9=[0,d("plugins/cc/cctac.ml"),254,9],ed=d("f"),ee=d("I don't know how to handle dependent equality"),eE=[0,0],ev=d("("),ew=d(")"),eq=[0,1],eo=d("Goal solved, generating proof ..."),en=d("Computation completed."),em=d("Problem built, solving ..."),el=d("Reading subgoal ..."),ep=[13,0,0,0],es=d("Goal is solvable by congruence but some arguments are missing."),et=d("  replacing metavariables by arbitrary terms."),eu=d(')",'),ex=d('"congruence with ('),ey=d("  Try "),ez=d("Incomplete"),eA=d("congruence failed"),ek=d(bQ),ej=d("H"),eh=d("e"),ei=d("X"),ef=d(bQ),ea=[0,0],eb=[0,1],d8=d("t"),dL=d("CC"),dM=d(aW),dN=[0,d($),[0,d(_),0]],dO=d("eq_rect"),dP=[0,d($),[0,d(_),0]],dR=d("eq_refl"),dS=[0,d($),[0,d(_),0]],dT=d("eq_sym"),dU=[0,d($),[0,d(_),0]],dW=d("eq_trans"),dX=[0,d($),[0,d(_),0]],dY=d("eq"),dZ=[0,d($),[0,d(_),0]],d0=d("False"),d1=[0,d($),[0,d(_),0]],eB=d("congruence failed."),eL=d(bT),eM=d(bS),eO=d(bL),eP=d(aD),eS=d(bT),eT=d(bS),eU=d(aD),eX=d(bL),eY=d(aD),e0=[0,d(aD),0],e2=d("cc"),e4=[0,d(aW),0],e6=d(aW),dk=h.Vars,di=h.Namegen,bW=h.Pfedit,b1=h.Goptions,d3=h.Global,d4=h.Inductiveops,d5=h.Retyping,d_=h.Evarutil,eG=h.Pretype_errors,eH=h.Type_errors,er=h.Detyping,ec=h.Evd,d$=h.Refine,eI=h.Mltop,V=5;function
am(c){var
...
b2=g[1],b3=[0,function(b,a){return b===a?1:0},b2],an=a(ad[19],b3);function
b4(b,a){var
...
d=aj(h,f);return 0===d?i(j[17][44],aj,g,e):d}return c}],cb=[0,function(b,a){var
...
F=a(ad[19],[0,o[79],o[93]]),W=a(ad[19],[0,aI,aJ]),aK=a(ad[19],[0,n[1][1],n[1][3]]),cc=[0,a(o[1],af[8])],a2=[0,[1,af[8],[0,af[8],af[8],0]],af[8],m[1],0,cc];function
a3(c){var
...
9:var
F=c[1],G=b(j[19][72][1],d,c[2]),H=[0,d(F),G];return a(o[13],H);case
10:var
...
c(c,b){return c===y(a[1],b)?1:0}return i(j[19][32],c,g,b)},l=b(j[17][22],k,h);return l}catch(a){a=s(a);if(a===t)return 0;throw a}}function
cV(e,b,a,d){var
...
h!=="number"&&0===h[0]){var
f=h[1],w=G(ab(d[1],f[1])),x=a(e[8],w),y=i(P[1],d[13],d[14],x),z=a(e[bR][1],y),A=f[3],B=function(a){return G(ab(d[1],a))},C=b(j[17][67],B,A),E=a(j[17][9],C),F=b(a8[28],z,E),H=f[2],l=ab(d[1],p),m=F,k=H;for(;;){if(0<k){var
n=a(o[60],m),t=n[3],u=a(e[8],n[2]),q=a(bd[11],d[13]),r=a(bd[32],q),g=b(di[26],dh,r);d[13]=b(e[111],[0,g,u],d[13]);var
...
d=a(c[3],cC);return i(D[3],0,0,d)}throw b}},l=b(j[19][15],r,m),u=a(o[2],f[1]),p=b(j[19][15],G,l);a(j[19][41],p);var
...
ar=[0,ag,ac,A,L,bi,bj,bl,Q,bm,aq,bn,aS,function(c,b){if(bG<=b[1]){var
...
6:var
l=d[3],m=d[2];if(i(e[aE][13],c,1,l)){var
...
k=b(M[60],c,g);if(b(e[aE][16],c,k))return[0,i(e[5],d2,c,k)];throw t}}function
aV(d,c,g){var
...
6:var
l=f[3],m=f[2];if(i(e[aE][13],c,1,l)){var
...
9:var
z=f[2],A=C(d,c,f[1]),B=function(a){return ah(d,c,a)},D=b(j[19][50],B,z),q=a(j[17][121],D),E=q[1],F=i(j[17][15],g[2][7],g[2][1],q[2]);return[0,[0,A,a(j[17][9],E)],F]}var
s=C(d,c,h);return[0,[0,s,0],g[2][1]]}function
bt(a){return 0===a[0]?1:0}function
bu(k,c,j,v){try{var
x=as(k,c,v),l=b(e[73],c,x)}catch(a){a=s(a);if(a===o[54])throw t;throw a}var
...
j=g[3],k=g[2],l=T(R),q=g[1],r=U===l?R[1]:N===l?a(S[2],R):R;if(i(M[al],c,r,j))return[0,bO,bu(d,c,f,k)];var
d=b(e[bV],[0,q,k],d),f=f+1|0,h=j;continue}return[0,bH,bu(d,c,f,h)]}}function
d7(d,c,g){var
...
j=h[2];return[0,bJ,[0,j[1],j[2],j[3]]]}return[0,bU,h[2]]}try{var
q=d6(b(e[bV],[0,o,l],d),c,1,k);return q}catch(a){a=s(a);if(a===t)return[0,aY,C(d,c,g)];throw a}}return aV(d,c,g)}function
Y(c,g,f){var
d=T(c);function
...
t=g[3],l=e7(d_[4],0,0,0,0,0,0,0,q,c,g[2]),m=l[2],u=l[1],c=u,k=b(e[aE][5],m,t),f=f-1|0,d=[0,m,d];continue}throw[0,bb,d9]}}return b(d$[2],0,c)}var
...
Q(i){var
h=a(bv[2][1][1],i),e=a(o[2],h),c=d7(z,r,a(bv[2][1][3],i)),g=c[1];if(aB<=g){if(bO<=g)return bH<=g?B(f[15],d,h,1,c[2]):B(f[15],d,h,0,c[2]);if(bJ<=g){var
k=c[2];return B(f[14],d,[0,e],k[2],k[3])}var
l=c[2];return B(f[13],d,e,l[2],l[3])}if(bU<=g){var
...
l=b(j[17][14],k,i),d=h[1],m=d[1],n=c[2],o=[0,m,a(e[2][1],d[2])],p=[0,a(e[28],o),l];return[0,a(e[34],p),n]},af=b(j[17][67],ae,ad),ag=b(bB[3],0,ep),ah=function(a){var
c=a[2],d=aA(er[9],0,eq,0,n[1][10][1],L,_,a[1]);function
e(a){return ag}var
f=[4,d,b(j[17][54],c,e)],g=b(bB[3],0,f);return b(aZ[42],L,g)},ai=a(c[3],es);b(aH[6],0,ai);var
...
v=t[1],M=v[2],F=b(ar[13],g,[0,bG,[0,v[1],M,v[3],v[4]]]);b(f[21],g,M[1]);var
W=function(c){var
