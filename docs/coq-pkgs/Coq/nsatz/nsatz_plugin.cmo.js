...
ae="*",bj="term computed",br="plugins/nsatz/polynom.ml",bi="+",bh="@[%s@]",q=250,aL="(",J="setoid_ring",bl="+ ",bq="Init",bg="...",i=246,bp="h",aI=" ",aJ=113,bn=477,af="1",be="nsatz_compute",bf="print_pol dans dansideal",bo=")*",ad="plugins/nsatz/nsatz.ml",bk="c",B="",an="^",I="Ring_polynom",H="0",aK=248,bm="u",L="\n",u="CC",o=eY.jsoo_runtime,f=o.caml_check_bound,aH=o.caml_equal,bb=o.caml_fresh_oo_id,aG=o.caml_int_compare,bd=o.caml_int_of_string,eW=o.caml_list_of_js_array,x=o.caml_make_vect,b=o.caml_new_string,p=o.caml_obj_tag,R=o.caml_register_global,ab=o.caml_string_equal,ac=o.caml_string_notequal,ba=o.caml_trampoline,aF=o.caml_trampoline_return,z=o.caml_wrap_exception;function
...
g=a(k,b[1],e);d[1]=[0,f,d[1]];b[1]=g;continue}}catch(a){a=z(a);if(c(T[18],a))return 0;throw a}};a(ap[14],l,e)}var
...
aj(a){return 0===a[0]?a[1]:c(d[2],bF)}function
...
d=b[1],f=c(e[19][11],b[2]),g=[0,[0,d,0],a(e[17][67],_,f)];return c(e[17][57],g)}function
$(d,g,c){if(1===c[0]){var
...
ac(b){if(aa[1]){var
f=c(d[21],b);return a(d[16],bH,f)}if(3<b){var
...
u=c(g[15],o),v=a(d[16],u,bI);return a(d[16],bJ,v)}var
...
z=a(d[16],bS,m),A=a(d[16],k,z);h[1]=a(d[16],bT,A)}else{var
B=a(d[16],bU,m);h[1]=a(d[16],k,B)}}}else
if(1-ab(k,bV)){i[1]=i[1]-1|0;if(ab(k,bW)){var
C=c(d[21],l),D=a(d[16],bX,C);h[1]=a(d[16],m,D)}else
if(a(e[15][22],k,43)){var
E=c(d[21],l),F=a(d[16],bY,E),G=a(d[16],m,F),H=a(d[16],bZ,G),I=a(d[16],k,H);h[1]=a(d[16],b0,I)}else{var
J=c(d[21],l),K=a(d[16],b1,J),L=a(d[16],m,K),M=a(d[16],b2,L);h[1]=a(d[16],k,M)}}var
t=1-c(e[15][36],h[1]),w=t?1-q[1]:t;if(w){i[1]=i[1]-1|0;if(c(e[15][36],j[1]))j[1]=h[1];else{var
y=a(d[16],bR,h[1]);j[1]=a(d[16],j[1],y)}}}else{h[1]=b3;if(1-q[1]){var
N=a(d[16],b4,h[1]);j[1]=a(d[16],j[1],N)}q[1]=1}var
x=l-1|0;if(1!==l){var
l=x;continue}break}}if(c(e[15][36],j[1])){i[1]=i[1]-1|0;j[1]=bN}return j[1]}return b5}function
v(a){i[1]=20;return R(a)}function
as(b){var
c=v(b);return a(ao[aJ],b6,c)}function
ad(f){var
b=[0,b7];function
g(c){var
e=v(c),f=a(d[16],e,b8);b[1]=a(d[16],b[1],f);return 0}a(e[19][13],g,f);var
h=a(d[16],b[1],b9);return c(j[3],h)}function
at(a){return ad(c(e[19][12],a))}function
F(j,i,e){if(0===e){if(0===j[0]){var
o=j[1];if(0===i[0]){var
s=i[1],x=a(g[10],o,s);return a(g[1],x,b)?[0,[0,a(g[9],o,s)],k]:c(d[2],b_)}}throw[0,K,b$]}var
...
j=c(d[21],b),l=a(d[16],j,ca),m=a(d[16],cb,l),o=a(d[16],cc,m),p=v(h),q=a(d[16],p,o),r=a(d[16],cd,q),s=a(d[16],ce,r),t=v(e),u=a(d[16],t,s),w=a(d[16],cf,u),x=a(d[16],cg,w),y=v(f),z=a(d[16],y,x),A=a(d[16],ch,z),B=a(d[16],ci,A);return c(d[2],B)}function
au(c,b){var
...
y=c(e[17][49],R),S=[0,y,function(d){function
e(a){return a[1]}var
...
h=c(d[21],e),i=a(d[16],cq,h),j=function(c,b){var
e=a(d[16],cs,b);return a(d[16],c,e)},k=l(g[20],j,cr,f);return a(d[16],k,i)}throw b}}function
q(h,e){var
m=h[1];function
g(j,i){var
e=[0,0],k=j.length-1-1|0,l=1;if(!(k<1)){var
b=l;for(;;){var
t=f(j,b)[b+1],h=c(d[21],t);if(ac(h,cy))if(ac(h,cz)){var
o=a(d[16],cA,h),p=B(m,b-1|0),q=[0,a(d[16],p,o),0];e[1]=a(d[25],e[1],q)}else{var
s=[0,B(m,b-1|0),0];e[1]=a(d[25],e[1],s)}var
r=b+1|0;if(k!==b){var
b=r;continue}break}}var
g=e[1];if(g){if(i)return a(au[7],ct,g);var
n=a(au[7],cu,g);return a(d[16],cv,n)}return i?cw:cx}function
k(i,j){var
z=i?0:1;if(z)return j?cK:cL;var
A=0,B=i?i[2]:c(d[2],cN),C=k(B,A),D=a(d[16],cM,C),m=i?i[1]:c(d[2],cO),h=m[2],n=c(b[39],m[1]),p=a(d[16],n,co),e=a(d[16],cp,p);if(ac(e,cB))if(ac(e,cC))if(ac(e,cD))if(45===o.caml_string_get(e,0))var
q=g(h,0),r=l(au[4],e,1,o.caml_ml_string_length(e)-1|0),s=a(d[16],r,q),f=a(d[16],cE,s);else
if(0===j)var
t=g(h,0),u=a(d[16],e,t),f=a(d[16],cF,u);else
var
v=g(h,0),f=a(d[16],e,v);else
if(0===j)var
w=g(h,1),f=a(d[16],cG,w);else
var
f=g(h,1);else
var
f=cH;else
var
x=g(h,1),y=a(d[16],cI,x),f=a(d[16],cJ,y);return a(d[16],f,D)}return k(e,1)}function
u(e,b){if(10<c(g[1],b))var
h=c(g[1],b),i=c(d[21],h),j=a(d[16],i,cP),k=a(d[16],cQ,j),l=q(e,[0,c(g[5],b),0]),f=a(d[16],l,k);else
var
...
l=c+1|0;if(d!==c){var
c=l;continue}break}}return[0,a(b[22],m,o),e]}return a(av[67],d,c)}function
...
E(c){var
b=u(f,o);return a(d[16],cU,b)}c(j[5],E);var
y=[0,o,a(b[22],t[2],D)];if(o)throw[0,w,y];c(j[6],cV);function
F(a){return 0}var
H=a(g[17],F,e),i=y[2],z=I(m,p(i,s),e,H),A=z[1],J=z[2];c(j[6],cW);function
K(c){var
b=q(f,J);return a(d[16],cX,b)}c(j[5],K);function
L(k){function
b(c,b,a){return h(c,v(b,a[1]))}var
c=p(i,s),j=q(f,bc(g[25],b,c,A,e));return a(d[16],cY,j)}c(j[5],L);function
M(c){var
b=q(f,k(1,i));return a(d[16],cZ,b)}c(j[5],M);var
r=0,l=c(g[9],e);for(;;){if(l){var
B=l[2],N=l[1],O=function(b){return function(a){return $(m,b,a)}}(N),r=[0,a(g[17],O,B),r],l=B;continue}var
P=a(av[111],C,r),Q=function(a){return p(n(-1),a)};return[0,i,1,P,a(g[19],Q,A)]}}function
...
b=u(r,c[1]);return a(d[16],c2,b)}}(q);c(j[5],_);var
M=ab(q,b);try{var
...
f=[0,0,a(D[1],0,51),0,x(1e3,aw)],m=a(g[27],ao,[0,b,i]);if(m)c(j[6],c5);function
q(f){var
c=u(e,b);return a(d[16],c6,c)}c(j[5],q);function
r(f){function
b(c,b){var
f=u(e,b),g=a(d[16],f,c8);return a(d[16],c,g)}var
c=l(g[20],b,c7,i);return a(d[16],c9,c)}c(j[5],r);function
...
az=[i,function(a){return t(dr,dq,dp)}],O=[i,function(a){return t(du,dt,ds)}],V=[i,function(a){return t(dx,dw,dv)}],W=[i,function(a){return t(dA,dz,dy)}],X=[i,function(a){return t(dD,dC,dB)}],Y=[i,function(a){return t(dG,dF,dE)}],Z=[i,function(a){return t(dJ,dI,dH)}],_=[i,function(a){return t(dM,dL,dK)}],a2=[i,function(a){return t(dO,aA,dN)}],a3=[i,function(a){return t(dQ,aA,dP)}],a4=[i,function(a){return t(dS,aA,dR)}],h=[i,function(a){return t(dU,E,dT)}],ak=[i,function(a){return t(dW,E,dV)}],$=[i,function(a){return t(dY,E,dX)}],d1=[i,function(a){return t(d0,E,dZ)}],d4=[i,function(a){return t(d3,E,d2)}],aa=[i,function(a){return t(d6,E,d5)}],al=[i,function(a){return t(d8,E,d7)}],am=[i,function(a){return t(d_,E,d9)}],eb=[i,function(a){return t(ea,E,d$)}];function
r(a,d){var
b=p(a),f=c(e[19][12],d),g=q===b?a[1]:i===b?c(n[2],a):a;return c(w[13],[0,g,f])}function
aB(f){var
a=p(h),b=0,d=0,e=q===a?h[1]:i===a?c(n[2],h):h;return r(a2,[0,r(az,[0,e,d]),b])}function
...
z=c(ax[2],d),f=p(h),B=[0,a5(c(m[51],z)),0],D=q===f?h[1]:i===f?c(n[2],h):h;return r(O,[0,D,B]);case
1:var
...
a7=c(ar[1],[0,aW,aX,db,dc,dd,de,df,dg,dh,aY,dk,dl,dj,aV,di]),s=c(v[2],a7);function
aC(h,a){var
b=c(s[1],a);function
g(b){if(b){var
...
g(e,b,a){var
g=a0([0,[1,c(d[21],f)],e]);return ay([0,a,a1([0,i(b),g])])}return l(e[19][42],g,b,0)},j=i(r);return c(e[17][46],k)?j:ay([0,j,g(k)])}var
t=function(i,g){var
b=g[2],j=g[1],k=i[2],l=i[1];if(h<=f(c(v[1][1],b),a)[a+1]){var
m=c(v[1][1],b),d=c(e[19][8],m);d[a+1]=f(d,a)[a+1]-h|0;return[0,[0,[0,j,c(v[1][2],d)],l],k]}return[0,l,[0,[0,j,b],k]]},q=l(e[17][15],t,eg,b),u=q[2],w=q[1],x=1===h?[1,c(d[21],a)]:a0([0,[1,c(d[21],a)],h]),y=g(c(e[17][9],u));return ay([0,a1([0,x,g(c(e[17][9],w))]),y])}return aZ(c(m[43],eh))}return g(b)}function
a9(b,a){function
...
eE(aw){var
u=a6(aw),g=l(e[17][15],ee,0,u);if(u){var
w=u[1];if(typeof
w==="number")var
d=0;else
if(0===w[0]){var
...
_=function(b){return a(M[4],ep,b+1|0)},$=a(e[17][54],g,_),aa=[0,a(e[18],eq,$)],ab=function(b){function
d(b){if(typeof
b==="number")var
e=s[3];else
switch(b[0]){case
...
z=b[2],A=d(b[1]),e=a(s[9],A,z)}return e}return d(b)},B=a(e[17][67],ab,Y);if(B){var
...
c=(b+a|0)+1|0;return f(o,c)[c+1]}return f(o,b)[b+1]?[0,a(e[17][61],d,c)]:0},b=a(av[65],R,D),S=function(f){var
d=k-c(e[17][1],b)|0;return a(M[4],ei,d)};c(j[5],S);var
U=function(f){var
d=c(e[17][1],b);return a(M[4],ej,d)};c(j[5],U);if(b){var
ah=b[2],ai=a9(Q,b[1]),ak=aC(g,a(s[2],g,t[1])),al=[6,0,t[2]],am=c(e[17][9],ah),an=function(a){return a9(Q,a)},ao=a(e[17][67],an,am),ap=function(a){return aC(g,a)},aq=c(e[17][67],ap),ar=a(e[17][67],aq,ao),as=function(a){return aC(g,a)},at=a(e[17][67],as,ai),au=function(b){return a(M[4],es,P)};c(j[5],au);c(j[6],et);var
ax=a(e[18],[0,[0,ak,[0,al,at]],0],ar),ay=function(b){return a(e[17][67],F,b)},aA=a(e[17][67],ay,ax),aD=r(a3,[0,aB(0),0]),aE=function(d,b){var
a=p(h),f=0,g=0,j=q===a?h[1]:i===a?c(n[2],h):h,k=r(a3,[0,r(az,[0,j,g]),f]);function
m(d,b){var
a=p(h),e=[0,d,[0,b,0]],f=0,g=q===a?h[1]:i===a?c(n[2],h):h;return r(a4,[0,r(az,[0,g,f]),e])}var
o=[0,l(e[17][16],m,d,k),[0,b,0]];return r(a4,[0,aB(0),o])},aF=l(e[17][16],aE,aA,aD);c(j[6],eF);return aF}throw[0,K,eu]}throw[0,K,ev]}var
d=1,E=0}else
var
E=1;if(E)var
d=1}else
...
eG(a){var
b=[0,r(a2,[0,aB(0),0]),a],d=[0,t(eJ,eI,eH),b],e=c(w[13],d),f=[0,c(a_[8],e),0];return c(eK[146],f)}var
aD=[0,function(a){try{var
e=eE(a),b=e}catch(a){a=z(a);if(a!==v[3])throw a;var
d=c(ag[3],eL),b=l(T[6],0,0,d)}return eG(b)}];R(220,aD,"Nsatz_plugin.Nsatz");c(eM[10],aE);var
eN=0;function
eO(a,d){var
b=c(a_[128][1],a);return c(aD[1],b)}var
eT=[0,[0,[0,eS,[1,[5,c(eR[16],eQ[11])],eP,0]],eO],eN];eX(eV[10][8],aE,eU,0,0,eT);var
a$=[0,aE];R(225,a$,"Nsatz_plugin.G_nsatz");R(226,[0,j,ar,v,aD,a$],"Nsatz_plugin");return}
