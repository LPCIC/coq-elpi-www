...
bd=104,cz=",",K='"',cy="field_mod",r=250,cx="(",cw="constants",aM="Field_tac",cd="with carrier ",cu="postprocess tactic",cv="Init",aL="field",ct="InitialRing",m=246,cc="decidable",cq="Pphi_pow",cr='Using setoid "',cs="tactic recognizing constants",cp="l",co="postprocess",bc="gen_phiZ",aN="setoid",cn="ring_mod",C="]",cb="preprocess",a_="power_tac",cl=128,cm="Print",bb="power",ck="Ring_polynom",ba="protect_fv",ak="Ring",ca='and "',b$=103,b_="morphism",a9="plugins/setoid_ring/newring.ml",cj="field_lookup",$="Coq",b8="lH",b9="closed",a$="x",b7="ring_lookup",b6="f",a8="ring",ci=105,b4="map",b5="preprocess tactic",B="[",ch='and morphisms "',b3="and equivalence relation ",b2=")",b0="field_mods",b1=":",aK="t",bZ="abstract",aJ="sign",bY="PEeval",aI="div",a7="newring_plugin",cf="Add",cg="completeness",a5="id",a6="IDphi",ce="ring_mods",bX="Pphi_dev",J=j$.jsoo_runtime,G=J.caml_check_bound,b=J.caml_new_string,q=J.caml_obj_tag,aH=J.caml_register_global,A=J.caml_wrap_exception;function
...
f=J.caml_get_global_data(),bi=[0,b(a7),b("closed_term")],bp=[0,b(a7),b("get_res")],br=[0,[0,b($),[0,b("Setoids"),[0,b("Setoid"),0]]],[0,[0,b($),[0,b("Lists"),[0,b("List"),0]]],[0,[0,b($),[0,b(cv),[0,b("Datatypes"),0]]],[0,[0,b($),[0,b(cv),[0,b("Logic"),0]]],0]]]],an=b("setoid_ring"),aj=b(a7),X=f.Constr,h=f.Util,Q=f.CClosure,ae=f.Termops,al=f.Globnames,H=f.Not_found,i=f.EConstr,bO=f.Tacmach,s=f.Proofview,g=f.Ltac_plugin,O=f.Coqlib,aa=f.Global,l=f.Names,x=f.Pervasives,bK=f.Lib,p=f.CamlinternalLazy,aU=f.UnivGen,y=f.Mod_subst,U=f.Libnames,_=f.Retyping,bx=f.Reductionops,d=f.Pp,W=f.CErrors,D=f.Printer,aS=f.Assert_failure,aw=f.Typing,aT=f.Option,Y=f.Evarutil,bE=f.Smartlocate,I=f.Loc,ad=f.Feedback,bA=f.Flags,v=f.Stdarg,j=f.Genarg,af=f.Evd,bm=f.Univops,bn=f.Declare,bl=f.Constrintern,bh=f.Tactics,at=f.Summary,au=f.Libobject,aF=f.Vernac_classifier,bS=f.Pfedit,E=f.Ppconstr,n=f.Pcoq,k=f.CLexer,bT=f.Vernacentries,be=[0],cE=f.Esubst,c1=f.CAst,c3=f.Refiner,cU=f.Environ,cV=f.Goal,cQ=f.DAst,cM=f.Tacticals,fL=f.Redexpr,gD=f.Mltop;aH(272,be,"Newring_plugin.Newring_ast");var
gB=[0,0,0],gC=[0,0,0],gq=b("field kind"),gr=b(cs),gs=b(b5),gt=b(cu),gu=b(aN),gv=b(bb),gw=b(aJ),gx=b(aI),gy=b("infinite property"),gg=[0,b(aM),0],gh=[0,0,0],gi=b("field_lemmas"),gj=b("_field_lemma1"),gk=b("_field_lemma2"),gl=b("_field_lemma3"),gm=b("_field_lemma4"),gn=b("_lemma5"),gp=[22,0],go=[22,0],gf=b("field inverse should be declared as a morphism"),f2=b("arguments of field_simplify do not have all the same type"),f3=[0,b(aL)],f1=[0,b(aM),0],f4=b(K),f5=b(K),f6=b("cannot find a declared field structure over"),f7=[0,b(aL)],f8=[0,b(a9),856,12],fW=[0,1],fX=[0,0],fV=b("bad field structure"),eY=[0,0,0],eZ=[0,0,0],eO=b("ring kind"),eP=b(cs),eQ=b(b5),eR=b(cu),eS=b(aN),eT=b(bb),eU=b(aJ),eV=b(aI),eN=b(" cannot be set twice"),eH=[0,b("Ring_base"),0],eI=b("ring_lemmas"),eJ=b("_ring_lemma1"),eK=b("_ring_lemma2"),eM=[22,0],eL=[22,0],eF=[0,1],eG=[0,0],eE=b("bad ring structure"),en=b("ring addition should be declared as a morphism"),eo=b("ring multiplication should be declared as a morphism"),ep=b("ring opposite should be declared as a morphism"),eq=b(K),er=b(ca),es=b(K),et=b(K),eu=b('",'),ev=b(ch),ew=b(K),ex=b(cr),ey=b(K),ez=b(ca),eA=b(K),eB=b(ch),eC=b(K),eD=b(cr),ej=b("cannot find setoid relation"),d7=b("arguments of ring_simplify do not have all the same type"),d8=[0,b(a8)],d9=b(K),d_=b(K),d$=b("cannot find a declared ring structure over"),ea=[0,b(a8)],eb=[0,b(a9),354,12],dn=[0,b(ck),0],dm=b("newring"),dh=b(ak),dg=b(ak),dc=b("ring: cannot find relation (not closed)"),db=b("ring: cannot find relation"),c5=b(ak),c4=b(ak),c2=b(a$),c0=b(a$),cY=b(a$),cW=b("Ring.exec_tactic: anomaly"),cS=[2,1],cT=[0,1],cP=b(aK),cR=b(aK),cL=[0,b(a9),116,7],cG=b("not found"),cH=b("map "),cI=[0,b("lookup_map")],cD=b("dummy"),cB=b("global_head_of_constr."),c6=b("Build_Setoid_Theory"),c8=b("None"),c9=b("Some"),c_=b("eq"),c$=b("cons"),da=b("nil"),dd=b($),de=[0,[0,b("Ring_theory"),0],[0,[0,b(ck),0],[0,[0,b("Ring_tac"),0],[0,[0,b(ct),0],[0,[0,b(aM),0],[0,[0,b("Field_theory"),0],0]]]]]],di=[0,b($),0],dj=b(ct),dp=b("almost_ring_theory"),dq=b("Eqsth"),ds=b("Eq_ext"),du=b("Eq_s_ext"),dw=b("ring_theory"),dx=b("mk_reqe"),dz=b("semi_ring_theory"),dA=b("mk_seqe"),dC=b("Abstract"),dD=b("Computational"),dF=b("Morphism"),dH=b("inv_morph_nothing"),dI=b("mkhypo"),dK=b("hypo"),dN=b(bY),dQ=b(cq),dT=b(bX),dW=b(bc),dZ=b(a6),d3=b(a8),d4=b("ring-tac-carrier-table"),d5=b("ring-tac-name-table"),ed=b("tactic-new-ring-theory"),e1=[0,b($),0],e2=b(aM),e7=b("FEeval"),e_=b(bY),fb=b(cq),fe=b(bX),fh=b("display_pow_linear"),fk=b("display_linear"),fn=b(bc),fq=b(a6),fu=b(aL),fx=b("PCond"),fA=b(bc),fD=b(a6),fH=b("field_cond"),fI=b(aL),fK=b("simpl_field_expr"),fM=b("almost_field_theory"),fN=b("field_theory"),fO=b("semi_field_theory"),fP=b("AF_AR"),fR=b("F_R"),fT=b("SF_SR"),fY=b("field-tac-carrier-table"),fZ=b("field-tac-name-table"),f_=b("tactic-new-field-theory"),jG=b(b3),jH=b(cd),jF=b("The following field structures have been declared:"),je=b(cg),iM=b(b3),iN=b(cd),iL=b("The following ring structures have been declared:"),hn=[0,0],gR=b(bZ),gS=b(cc),gT=b(b_),gU=b(C),gV=b(B),gW=b(cw),gX=b(C),gY=b(B),gZ=b(b9),g0=b(C),g1=b(B),g2=b(cb),g3=b(C),g4=b(B),g5=b(co),g6=b(aN),g7=b(C),g8=b(B),g9=b(a_),g_=b(C),g$=b(B),ha=b(a_),hb=b(aJ),hc=b(aI),gG=b(b4),gH=b(ba),gK=b(a5),gL=b("in"),gN=b(b4),gO=b(ba),gQ=b(ba),hd=b(cn),hf=b(cn),hk=b(cc),ho=b(bZ),hs=b(b_),hv=b(C),hy=b(B),hA=b(cw),hD=b(C),hG=b(B),hI=b(b9),hL=b(C),hO=b(B),hQ=b(cb),hT=b(C),hW=b(B),hY=b(co),h3=b(aN),h7=b(aJ),h_=b(C),ib=b(B),ie=b(bb),ii=b(C),il=b(B),ip=b(a_),it=b(aI),iw=b(ce),iy=b(ce),iC=b(b2),iE=b(cz),iG=b(cx),iO=[0,b(cm),[0,b("Rings"),0]],iS=[0,b(cp)],iU=[0,b(aK)],iV=b(b1),iX=[0,b(a5)],iY=b(ak),iZ=b(cf),i3=b("AddSetoidRing"),i6=b("lrt"),i7=b(C),i9=b(b8),i_=b(B),ja=b(b6),jb=b(b7),jd=b(b7),jf=b(cy),jh=b(cy),jn=b(cg),jq=b(b0),js=b(b0),jw=b(b2),jy=b(cz),jA=b(cx),jI=[0,b(cm),[0,b("Fields"),0]],jM=[0,b(cp)],jO=[0,b(aK)],jP=b(b1),jR=[0,b(a5)],jS=b("Field"),jT=b(cf),jX=b("AddSetoidField"),j0=b("lt"),j1=b(C),j3=b(b8),j4=b(B),j6=b(b6),j7=b(cj),j9=b(cj);function
L(b){var
c=a(d[3],b);return e(W[6],0,0,c)}function
cA(b,f){var
g=c(i[82],b,f)[1];try{var
j=c(ae[b$],b,g)[1];return j}catch(b){b=A(b);if(b===H){var
...
1:return a(Q[38],b);default:return bf(g,f,b)}};if(a(h[19][28],j))return d(-1,b);var
m=c(h[19][16],d,j),n=[6,d(-1,b),m];return a(Q[39],n)}return a(Q[38],e)}function
bg(b,a){try{var
c=[0,e(h[17][117],l[68][1],a,b)];return c}catch(a){a=A(a);if(a===H)return 0;throw a}}var
aO=[0,h[15][49][1]];function
aP(b,a){aO[1]=e(h[15][49][4],b,a,aO[1]);return 0}function
cF(f){try{var
b=c(h[15][49][22],f,aO[1]);return b}catch(b){b=A(b);if(b===H){var
g=a(d[3],cG),i=a(d[20],f),j=a(d[3],cH),k=c(d[12],j,i),l=c(d[12],k,g);return e(W[6],0,cI,l)}throw b}}function
aQ(h,g,f,b){function
j(a){return c(Y[12],f,a)}var
k=a(i[cl][1],b),l=a(Q[22],0),m=e(Q[43],[0,j],Q[8],g),n=c(cF(h),f,b);function
d(c,f){var
...
aR(a,e,b){var
f=b;for(;;)try{var
l=c(ae[b$],a,f)[1],m=c(al[21][3],l,e);return m}catch(b){b=A(b);if(b===H){var
d=c(i[3],a,f);switch(d[0]){case
5:var
f=d[1];continue;case
9:var
j=d[2],g=aR(a,e,d[1]);if(g){var
k=function(b){return aR(a,e,b)};return c(h[19][31],k,j)}return g;default:return 0}}throw b}}var
...
d=a(j[6],v[9]);return c(g[13][2][7],d,b)},p=c(h[17][67],o,n),q=function(b){if(aR(b,e(h[17][16],al[21][4],p,al[21][1]),l))return a(s[16],0);var
f=a(d[7],0);return c(cM[66][4],0,f)};return c(s[72][1],s[55],q)}}throw[0,aS,cL]}];e(g[4][16],0,bi,cN);var
cO=[0,bi,0];function
bj(b){function
d(a){return[0,c(I[11],0,a)]}var
e=c(h[17][67],d,b),f=a(j[18],v[9]),g=a(j[5],f),i=[0,[0,c(j[7],g,e)],0],k=[1,a(l[1][6],cP)],m=[0,c(cQ[3],0,k),0],n=a(j[5],v[11]),o=[0,cO,[0,[0,c(j[7],n,m)],i]],p=[31,c(I[11],0,o)];return[28,[0,[0,[0,a(l[1][6],cR)],0],p]]}function
bk(d){var
...
k(d){var
e=b[1],f=a(x[21],d),g=c(x[16],cY,f),h=a(l[1][6],g);return c(l[1][11][22],h,e)}bo[1]=c(h[19][2],i,k);return a(s[16],0)}];e(g[4][16],0,bp,cZ);function
bq(F,E,k,b,D){function
G(h,b){var
d=b[1],i=b[3],j=b[2],k=a(x[21],d),m=c(x[16],c0,k),f=a(l[1][6],m),n=[2,[1,c(c1[1],0,f)]],o=a(g[13][2][1],h);return[0,d+1|0,[0,n,j],e(l[1][11][4],f,o,i)]}var
n=e(h[17][16],G,D,[0,0,0,l[1][11][1]]),H=n[3],J=n[2],K=[0,H,a(g[13][31],0)[2]];function
L(b){var
d=a(x[21],b),e=c(x[16],c2,d);return a(l[1][6],e)}var
M=c(h[17][54],k,L),N=a(j[5],v[3]),O=[0,cX,[0,[0,c(j[7],N,k)],0]],Q=[31,c(I[11],0,O)];function
R(a){return[0,a]}var
S=[5,[28,[0,c(h[17][67],R,M),Q]]],z=af[2][1],A=i[14],B=a(cU[11],F),f=P(cV[3][6],E,B,A,z),C=[0,f[1],f[3]],d=q(b),T=c(h[18],J,[0,S,0]),t=r===d?b[1]:m===d?a(p[2],b):b,u=[0,[0,c(I[11],0,t)],T],w=[3,c(I[11],0,u)],y=[29,c(I[11],0,w)],U=c(g[13][23],K,y),V=c(s[71][7],U,C),W=a(c3[2],V),o=a(af[155],W);function
X(c){var
b=a(g[13][2][2],c);return b?e(i[5],0,o,b[1]):a(x[2],cW)}var
Y=a(af[140],o);return[0,c(h[19][15],X,bo[1]),Y]}function
...
n=[0,m,e(h[19][7],b,0,b.length-1-2|0)],g=a(i[21],n);if(c(i[107][16],f,g)){var
...
dk=c(h[17][67],l[1][6],[0,dj,[0,an,di]]),dl=a(l[5][4],dk);function
...
b=c[1],d=q(b),e=c[2],f=r===d?b[1]:m===d?a(p[2],b):b;return[0,f,e]},l=c(h[17][67],k,g),n=function(a){return-1===a?1:2},o=[0,[0,cA(d,j),n],l];return function(a){return bg(o,a)}}}var
dL=0;function
dM(b){var
...
F=q(R),aT=v[1],aU=r===F?R[1]:m===F?a(p[2],R):R;if(e(i[95],b[1],aT,aU)){var
...
f=b[1],i=bE[3],j=function(a){return c(i,0,a)};return bj(c(h[17][67],j,f))}var
...
x=a(i[cl][1],v);return c(Y[41],b[1],x)}function
bG(o,b,e){var
f=q(w),s=r===f?w[1]:m===f?a(p[2],w):w,i=c(Y[9],b[1],s),j=i[2];b[1]=i[1];if(e){var
k=e[1],d=k[1],u=k[2];if(0===d[0])var
l=a(g[9][3],d[1]);else
var
v=d[1],x=bE[3],y=function(a){return c(x,0,a)},l=bj(c(h[17][67],y,v));return[0,l,t(b,aW,[0,j,ax(o,b,M(u))])]}var
...
t=s[1];switch(v){case
0:var
w=q(ar),ae=b[1],af=b[2],ag=b[3],ah=b[4],ai=b[5],aj=b[6],ak=r===w?ar[1]:m===w?a(p[2],ar):ar;if(e(i[95],f,t,ak))var
d=[0,eF,ae,af,ag,ah,ai,0,0,aj],j=1;else
var
j=0;break;case
1:var
j=0;break;default:var
y=b[1],z=b[2],A=b[3],B=b[4],C=b[5],D=b[6],E=b[7],H=b[8],I=q(ap),al=r===I?ap[1]:m===I?a(p[2],ap):ap;if(e(i[95],f,t,al))var
d=[0,0,y,z,A,B,C,[0,D],[0,E],H],j=1;else{var
J=q(aq),am=r===J?aq[1]:m===J?a(p[2],aq):aq;if(e(i[95],f,t,am))var
...
j=0;if(!j)var
d=L(eE);var
S=d[9],T=d[8],U=d[6],V=d[5],W=d[2],n=[0,f],ax=d[4],ay=d[3],az=d[1],X=bB(k,n,W,V,U,T,S,av),Y=X[1],aA=X[2],$=bG(k,n,at),aB=$[2],aC=$[1],aD=bH(k,n,as),aE=bI(k,n,an),aF=[0,Y,[0,aA,[0,R,[0,aB,[0,aD,[0,aE,[0,bC(M),0]]]]]]],aG=bv(eI),ab=bq(k,n[1],5,aG,aF),ac=ab[2],o=ab[1],aH=G(o,3)[4],aI=G(o,4)[5],aJ=a(l[1][8],u),aK=Z(c(x[16],aJ,eJ),ac,aH),aL=a(l[1][8],u),aM=Z(c(x[16],aL,eK),ac,aI),aN=bD(k,f,M,az,[0,ay,ax,V,U,T],au),aO=Q?a(g[9][3],Q[1]):eM,aP=P?a(g[9][3],P[1]):eL,aQ=e(i[5],0,f,W),aR=e(i[5],0,f,S),aS=e(i[5],0,f,Y),aT=G(o,0)[1],aU=G(o,2)[3],aV=a(ei,[0,aQ,aR,aS,G(o,1)[2],aU,aT,aN,aC,aK,aM,aO,aP]);c(bK[6],u,aV);return 0}function
bL(a){return typeof
a==="number"?0:0===a[0]?[0,M(a[1])]:[1,M(a[1])]}function
u(e,b,d){return a(aT[3],b[1])?(b[1]=[0,d],0):L(c(x[16],e,eN))}function
eW(q,p,o){var
...
e3=c(h[17][67],l[1][6],[0,e2,[0,an,e1]]),e4=a(l[5][4],e3),e5=0;function
e6(b){var
...
d=c(h[17][67],b,fG);return function(a){return bg(d,a)}});function
...
l=q(R),s=h[1],t=r===l?R[1]:m===l?a(p[2],R):R;if(e(i[95],f[1],s,t)){var
...
var
ar=G(o,7)[8];var
a9=a(l[1][8],n),a_=Z(c(x[16],a9,gj),w,a3),a$=a(l[1][8],n),ba=Z(c(x[16],a$,gk),w,a4),bb=a(l[1][8],n),bc=Z(c(x[16],bb,gl),w,a5),be=a(l[1][8],n),bf=Z(c(x[16],be,gm),w,a6),bg=a(l[1][8],n),bh=Z(c(x[16],bg,gn),w,ar),bi=bD(k,v,R,aW,[0,aV,aU,ak,aj,ai],aK),bj=aJ?a(g[9][3],aJ[1]):gp,bl=aI?a(g[9][3],aI[1]):go,bm=e(i[5],0,v,Q),bn=a(gd,[0,bm,e(i[5],0,v,P),bi,aY,a_,ba,bc,bf,bh,bj,bl]);c(bK[6],n,bn);return 0}function
gA(a){var
...
i4=0;function
i5(e,d,c,f){var
b=a(h[17][ci],c);return P(N[5],e,d,b[2],b[1])}var
...
jY=0;function
jZ(e,d,c,f){var
b=a(h[17][ci],c);return P(N[8],e,d,b[2],b[1])}var
