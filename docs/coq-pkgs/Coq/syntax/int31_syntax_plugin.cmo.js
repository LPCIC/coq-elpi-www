...
c=e.caml_get_global_data(),p=b("int31_syntax_plugin"),k=[0,b("Coq"),[0,b("Numbers"),[0,b("Cyclic"),[0,b(I),[0,b(I),0]]]]],m=b("int31_scope"),t=c.Mltop,h=c.Bigint,g=c.DAst,u=c.List,f=c.Names,E=c.Notation,T=c.Pp,V=c.CErrors,L=c.Libnames;a(t[10],p);var
