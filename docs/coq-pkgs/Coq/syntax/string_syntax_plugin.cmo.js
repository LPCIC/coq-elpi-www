...
g=c.caml_get_global_data(),p=a("string_syntax_plugin"),k=[0,a(I),[0,a(J),[0,a(u),0]]],t=a("string_scope"),v=g.Mltop,i=g.DAst,m=g.CamlinternalLazy,A=g.Names,s=g.Buffer,l=g.Ascii_syntax_plugin,E=g.Notation,P=g.Char,M=g.Coqlib;b(v[10],p);var
